...
应用端叙事和与 video demoiréing 论文的关系见 `doc/paper/planning/positioning.md`。其中去摩尔纹论文用于说明后续恢复模块和数据对齐背景，`Cinematic-L1 Video Stabilization with a Log-Homography Model` 用于支撑 homography 轨迹稳定化的理论表述。
